...
public class Laboratorio3 {
	...
	/*
	 * Este método va a configurar el navegador y abrirlo
	 */
	@BeforeSuite
	public void setUp() {
 ...
 // Cerrar el navegador
	...
	@Test(priority=3,description="Uso del Buscador")
	public void buscarPalabra2() {
		driver.findElement(By.xpath("//input[@id='search_query_top']")).sendKeys("dress");
		driver.findElement(By.xpath("//header/div[3]/div[1]/div[1]/div[2]/form[1]/button[1]")).click();
	}
	...
	public void registrarUsuario() throws Exception {
		// Captura de pantalla
			...
			FileUtils.copyFile(screen, new File("..\\Evidencia\\01_Pagina_Inicial.png"));
		
		//Escribir el correo y hacer click en el bóton
		WebElement txtEmail = driver.findElement(By.id("email_create"));
		txtEmail.sendKeys("correo5010@mailinator.com");
		// hacer click
	...
	//Hacer click en el boton Register
		...
		// Captura de pantalla
					screen = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
					FileUtils.copyFile(screen, new File("..\\Evidencia\\02_Pagina_Inicial.png"));
	...
	// Si luego de hacer clic en Registrar cambio de URL significa que pudo registrar el usuario
			...
			//para que falle
			//Assert.assertNotEquals(driver.getCurrentUrl(), driver.getCurrentUrl());
	}
